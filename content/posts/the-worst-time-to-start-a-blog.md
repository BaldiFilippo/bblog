...
At some point we started treating a blog like a business — a way to collect readers, get clicks, make money. And if that’s what a blog is, then sure, no traffic means no blog. But that was never the only reason to write. Maybe not even the best one.
...
Because that’s what I want this to be too: a record of one person reacting to the world as it goes by.

Ten years from now, a machine will still write a perfect summary of these years. What it won’t be able to do is show what it felt like to be here, unsure, and to write anyway.
